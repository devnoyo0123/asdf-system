package com.example.orderservice.adapter.dataaccess.outbox.resaturantapproval;

import com.example.modulecommon.outbox.OutboxStatus;
import com.example.modulecommon.saga.SagaStatus;
import com.example.orderservice.adapter.dataaccess.outbox.resaturantapproval.exception.ApprovalOutboxNotFoundException;
import com.example.orderservice.adapter.dataaccess.outbox.resaturantapproval.mapper.ApprovalOutboxDataAccessMapper;
import com.example.orderservice.adapter.dataaccess.outbox.resaturantapproval.repository.ApprovalOutboxJpaRepository;
